...
const isFinishedCheckBox = document.getElementById("inputBookIsComplete")

isFinishedCheckBox.addEventListener('change', function() {
    let text = isFinishedCheckBox.checked ? "Sudah Dibaca" : "Belum Dibaca"

    isFinished.innerHTML = text;
  });